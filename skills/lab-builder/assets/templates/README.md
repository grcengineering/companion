...
Once you've completed your [GRC Profile](../profile-template.md), choose the prompt that matches your current situation and goals.
...
**Use: [job-seeking.md](job-seeking.md)**
...
**Use: [career-transition.md](career-transition.md)**
...
**Start with [job-seeking.md](job-seeking.md)** if you're not currently employed in GRC or actively looking to change roles.
...
1. **Complete your GRC profile** in [profile-template.md](../profile-template.md)
...
1. Start a new chat
2. Paste your completed GRC profile from profile-template.md
...
2. Add profile-template.md as project knowledge
...
**[Go to job-seeking.md →](job-seeking.md)**

**[Go to career-transition.md →](career-transition.md)**
