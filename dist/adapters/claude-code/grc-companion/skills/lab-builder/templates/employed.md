...
**Use this prompt if:** You're currently working in a GRC role and want to build skills that demonstrate value, earn promotion, or practise solving real problems in a learning-safe way.

**Companion boundary:** Use fictionalized data, toy workflows, or sanitized examples. This lab should teach you how to think and build; it should not operate your real programme.
...
4. Receive a personalized learning lab that practises against real work patterns without operating your programme
...
Create a comprehensive learning lab that builds a skill or toy tool I can safely adapt to my current role after review.
...
**Need inspiration?** Check out [the TPRM SOC 2 parsing case study](../../../knowledge/case-studies/tprm-soc2-parsing/) to see a complete lab for automating SOC 2 reviews.
