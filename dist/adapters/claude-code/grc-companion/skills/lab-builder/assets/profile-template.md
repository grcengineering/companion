...
4. When ready to create a lab: Copy this entire file + a [user prompt](templates/) → paste into ChatGPT/Claude
...
2. **Pick a user prompt** - Go to [templates/](templates/) and choose:
   - [employed.md](templates/employed.md) - If you're working in GRC now
   - [job-seeking.md](templates/job-seeking.md) - If you're looking for GRC roles
   - [career-transition.md](templates/career-transition.md) - If you're new to GRC
...
**Questions?** Check the [main README](README.md) or see [how to choose your user prompt](templates/README.md)
